...
<head>
    ...
    <style>
        ...
        .auth-content {
            ...
            background-size: cover; /* Ensures the background image covers the entire auth-content */
            background-repeat: no-repeat;
            background-position: center;
            box-shadow: 0 0 10px rgba(0, 0, 0, 0.5); /* Optional: to add a shadow effect */
        }
        span {
            font-weight: bolder;
        }
    ...
    <div class="auth-content">
        <div class="company-details-serial" style="display: flex; flex-direction: row;">
                ...
                <div class="company-info" style="display: flex; flex-direction: row;">
                    ...
                    <div class="company-address-iso" style="display: flex; flex-direction: column; align-items: center;">
                        <div class="company-address" style="font-weight: bold; display: flex; flex-direction: column; align-items: center;">
                            <div style="font-size: 15px">Regd. Under the Company Act. 2013 Ministry of Corporate Affairs Government of India</div>
                            <div style="font-size: 15px">MSME Registration No. UDYAM-DL-02-0059128, NCS ID: S19E57-2059243605757</div>
                            <div style="font-size: 15px">Skill India Registration No: TP262941, Startap India Registration No:</div>
                        </div>
            ...
            <div class="serial" style="display: flex; flex-direction: column; justify-content: flex-end;">
                ...
                <div style="display: flex; justify-content: center; font-weight: bolder;">Sl No : 00{{$cl_id_count}}</div>
            </div>
        </div>
        <hr style="border: 2px solid rgb(1, 114, 94);">
        <div class="auth-head" style="display: flex; flex-direction: row; justify-content: space-between; align-items: center;">
            <div style="display: flex; flex-direction: column; align-items: center; flex-grow: 1;">
                ...
                <div class="center-name" style="font-size: x-large; font-weight: bolder;"><i>{{$center->cl_center_name}}</i></div>
                <div class="represent" style="font-weight: bold; font-size: large;"><i>Represented by <span style="font-size: x-large;">{{$center->cl_director_name}}</span></i></div>
            </div>
            <div style="flex-shrink: 0;">
                <img src="{{asset('admin/center_image/'.$center->cl_photo) }}" alt="passport_photo" style="width: auto; height: 100px;">
            </div>
        </div>
        <div class="center-details" style="display: flex; flex-direction: column; align-items: center; font-size: large;">
            <div style="font-weight: 500;"><i>Having its Office at :{{$center->cl_center_address}}</div>
